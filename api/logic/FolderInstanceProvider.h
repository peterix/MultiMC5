...
public:
	...
	/**
	 * Delete (or otherwise dispose of) the instance specified by id
	 */
	bool deleteInstance(const InstanceId & id) override;

	bool supportsTrash() const override
	{
		return true;
	}
	QList<TrashEntry> trash() const override;
